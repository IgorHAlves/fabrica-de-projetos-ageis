<template>
  <div class="bg-white rounded-lg shadow-lg p-6">
    ...
    <TableSkeleton v-if="isLoading" :columns="4" :rows="5" />
...
import { createCoupon, deleteCoupon, getCoupons } from '../Services/CouponsService'
...
async function loadCoupons() {
  ...
  try {
    ...
    if (error.response) {
      ...
      errorMessage = 'Erro de conexão. Verifique se a API está rodando em http://localhost:5229'
