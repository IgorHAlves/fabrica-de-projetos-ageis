<template>
    <nav class="flex justify-between items-center p-4 bg-white shadow border-b mt-2 shadow hover:shadow-lg transition">
        ...
        <!-- Carrinho -->
        <a href="/carrinho" class="ml-6 flex items-center gap-2 p-2 rounded-full border border-gray-300 bg-black hover:bg-gray-400 shadow">
    ...
    <nav class="flex justify-center gap-8 items-center p-4 bg-white shadow font-semibold border-b mt-2 shadow hover:shadow-lg transition">
        <ul class="flex gap-14 items-center">
            ...
            <li><a href="/produtos" class="hover:text-blue-500">Produtos</a></li>
