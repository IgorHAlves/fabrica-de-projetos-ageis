<template>
  <nav class="flex justify-between items-center p-4 bg-white shadow border-b mt-2 hover:shadow-lg transition">
    <!-- Logo -->
    <router-link to="/home">
      <div class="flex items-center gap-4">
        <h1 class="text-4xl md:text-2xl font-extrabold tracking-wide text-gray-900 hover">
          <span class="hover">CLOTHING</span> <span class="">E-COMMERCE</span>
        </h1>
      </div>
    </router-link>
    <!-- Barra de pesquisa -->
  ...
  <!-- Barra de rotas -->
  <nav
    class="flex justify-center gap-8 items-center p-4 bg-white shadow font-semibold border-b mt-2 hover:shadow-lg transition">
    <ul class="flex gap-14 items-center">
      <li><router-link to="/home" class="hover:text-blue-500">Home</router-link></li>
      <li><router-link to="/produtos" class="hover:text-blue-500">Produtos</router-link></li>
      <li><router-link to="/sobre" class="hover:text-blue-500">Sobre</router-link></li>
    </ul>
  </nav>
</template>
